...
class NatNetClient:
    def __init__( self, serverIP = "192.168.1.116", multicastIP = "239.255.42.99"):
        # Change this value to the IP address of the NatNet server.
        self.serverIPAddress = serverIP # "169.254.201.120"

        # This should match the multicast address listed in Motive's streaming settings.
        self.multicastAddress = multicastIP #"239.255.42.99"
